...
struct Gmak8AppTests {
    ...
    @Test func clusterOverviewSidebarAndCardsMatchDesign() {
        ...
        #expect(SettingsCopy.publishL1SSH.contains("22022"))
        #expect(SettingsCopy.publishL1SSHHelp.contains("proxy_conf"))
        #expect(!SettingsCopy.publishL1SSHHelp.contains("0.0.0.0"))
        #expect(!SettingsCopy.publishL1SSH.contains(":22 "))
